...
```sh
https://github.com/ylian121/security_system.git
```
```sh
cd security_system
```
...
```sh
pip install guizero smtplib opencv-python face-recognition numpy pveagle pvrecorder gpiozero flask
```
**Compile and Run the Project:**   
```sh
python Guardian_main.py
```
